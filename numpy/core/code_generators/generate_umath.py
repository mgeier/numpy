...
chartoname = {'?': 'bool',
              ...
              'O': 'OBJECT',
              'P': 'OBJECT',
              #'O' calls the given python builtin method 
              #'P' calls a custom implementation of the ufunc for objects
              }
...
nobool_or_datetime_or_obj = all[1:-3]+all[-1:]
intflt = ints+flts
